 ...
 */
export function finalizeAttributes(scope, injector, staticAttrs) {
	finalizeItems(scope, injector.parentNode, injector.attributes, changeAttribute, staticAttrs);
}
 ...
 * @param {*} newValue
 */
function changeAttribute(scope, elem, name, prevValue, newValue) {
