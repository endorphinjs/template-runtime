 ...
 */
export function dispose(host, injector, block, self) {
...
/**
 * Adds reference to given `component` in `injector`
 * @param {Injector} injector
 * @param {Component} component
 */
export function addComponent(injector, component) {
	injector.components.push(component);
}
